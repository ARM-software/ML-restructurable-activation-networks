...
from model import efficientnet_model, ran_e_model
...
def get_models():
    ...
    return  {
        ...
        'ran_e': ran_e_model.RAN_e.from_name,
    }
...
def get_image_size_from_model(arch):
    ...
    if 'ran_e' in arch:
        ran_e_name = arch
        if ran_e_name in ran_e_model.MODEL_CONFIGS:
            return ran_e_model.MODEL_CONFIGS[ran_e_name]['resolution']
    return None
